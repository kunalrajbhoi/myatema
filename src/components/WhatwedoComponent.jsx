                    ...
                    <div class="col-md-4">
                      <div class="service_box">
                        <div class="house_icon">
                          <img src="assest/images/icon-1.png" class="image_1"/>
                            <img src="assest/images/icon-4.png" class="image_2"/>
                            </div>
                      ...
                      <div class="col-md-4">
                        <div class="service_box active">
                          <div class="house_icon">
                            <img src="assest/images/icon-5.png" class="image_1"/>
                              <img src="assest/images/icon-5.png" class="image_2"/>
                              </div>
                        ...
                        <div class="col-md-4">
                          <div class="service_box">
                            <div class="house_icon">
                              <img src="assest/images/icon-3.png" class="image_1"/>
                                <img src="assest/images/icon-6.png" class="image_2"/>
                                </div>
